const quantitiesValues = document.querySelectorAll(".product__quantity-value");

const dictionary = {};

quantitiesValues.forEach((element, index) => {
  dictionary[index + 1] = +element.textContent;
});

const cartProductsDictionary = {};

quantitiesValues.forEach((element, index) => {
  cartProductsDictionary[index + 1] = null;
});
